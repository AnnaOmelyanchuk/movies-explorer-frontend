...
const api = new MainApi({
   ...
   // usermeUrl: 'http://localhost:3000/users/me',
    ...
    baseUrl: 'http://api.anyafilms.nomoredomainsicu.ru',
    moviesUrl: 'http://api.anyafilms.nomoredomainsicu.ru/movies',
    usermeUrl: 'http://api.anyafilms.nomoredomainsicu.ru/users/me',
